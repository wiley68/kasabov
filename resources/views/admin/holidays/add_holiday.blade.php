...
<div id="content">
    <div id="content-header">
      <div id="breadcrumb"> <a href="{{ route('admin.dashboard') }}" title="Административен панел" class="tip-bottom"><i class="icon-home"></i> Панел</a> <a href="{{ route('admin.view-holidays') }}">Групи Празници</a> <a href="{{ route('admin.add-holiday') }}">Добави група празник</a> </div>
      <h1>Група Празници</h1>
    </div>
            ...
            <div class="widget-content nopadding">
              <form class="form-horizontal" method="post" action="{{ route('admin.add-holiday') }}" name="add_holiday" id="add_holiday" novalidate="novalidate">
                ...
                <div class="form-actions">
                  <input type="submit" value="Добави група празник" class="btn btn-success">
