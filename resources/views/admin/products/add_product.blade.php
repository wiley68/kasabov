            ...
            <form enctype="multipart/form-data" class="form-horizontal" method="post"
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="send_from_id_txt" id="send_from_id_txt"
                                        placeholder="Избери населено място" />
                                    <input type="hidden" name="send_from_id" id="send_from_id" value="0" />
                                    <a id="btn_send_from_id" href="#choose_city_form" data-toggle="modal"
                            ...
                            <div id="send_free_available_for_send_free_id_div" class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="send_free_id_txt" id="send_free_id_txt"/>
                                    <input type="hidden" name="send_free_id" id="send_free_id"/>
                ...
                <div class="span6">
                    ...
                    <div class="widget-box">
                        ...
                        <div class="widget-content nopadding">
                            <div style="padding:10px;">
                                <input type="text" name="tag_add" id="tag_add"> <button id="btn_add_tag"
                                    class="btn btn-primary">Добави етикета</button>
